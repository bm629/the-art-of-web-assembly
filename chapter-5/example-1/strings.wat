(module
    ...
    (data (i32.const 0) "null-terminating string\00") ;; 23 bytes
    (data (i32.const 128) "another null-terminating string\00") ;; 30 bytes
    (data (i32.const 256) "Know the length of this string") ;; 30 bytes
    (data (i32.const 384) "Also know the length of this string") ;; 35 bytes
    (data (i32.const 512) "\16length-prefixed string") ;; 22 bytes
    (data (i32.const 640) "\1eanother length-prefixed string") ;; 30 bytes
